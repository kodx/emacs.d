...
;; Code modified by Yegor Bayev <baev.egor@gmail.com>
...
(defun color-theme-tangotangokx ()
  ...
  (color-theme-install
   '(color-theme-tangotangokx
     ...
     (font-lock-function-name-face ((t (:foreground "#fcaf3d" :bold t))))
     ...
     (gnus-header-content ((t (:foreground "#8ae234"))))
     (gnus-header-newsgroups-face ((t (:bold t :foreground "LightSkyBlue3"))))
     (gnus-signature-face ((t (:foreground "dark grey"))))
     ...
     (gnus-summary-low-ancient-face ((t (:foreground "lime green"))))
     (gnus-summary-low-read-face ((t (:foreground "royal blue"))))
     (gnus-summary-low-ticked-face ((t (:foreground "dark red"))))
     (gnus-summary-low-unread-face ((t (:foreground "white"))))
     ...
     (message-header-newsgroups-face ((t (:bold t :foreground "LightSkyBlue3"))))
...
(provide 'color-theme-tangotangokx)
